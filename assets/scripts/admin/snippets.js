(function () {
  ...
  var selector = '.vouchers-list vouchers .vouchers-table [ng-change="updateAllSelect(this)"]'
  selector += ', .vouchers-list vouchers .vouchers-table [ng-change="selectAll()"]'
  ...
  $(document).on('change', selector, function () {
    ...
    $injector.invoke(function ($rootScope, $compile, VoucherPrinterService, CatchHttpError, $timeout) {
      ...
      $('.vouchers-list .btn-group-padded:first').append($compile(
